...
| Phase 4 | Custom tag-generation LM (bitnet.hpp 33M) + identity conditioning / quality scorer; ternary as a compression experiment | ⏳ Dataset / model def / tokenizer / training done (#1–#4); top10 tag recall 0.777 |
