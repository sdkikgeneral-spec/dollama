...
| Phase 2-6d | **最新アニメ特化 SDXL への差し替え** — NoobAI-XL / Animagine XL 4.0 / Illustrious XL を 3 preset 対応 (全て SDXL アーキゆえカーネル無改修・重みのみ差し替え) | ✅ 完了 (2026-09-17・`models/presets/<name>/` の unet/vae/TE-L/TE-G 4 ファイル差し替え・既定 preset = illustrious-xl・素 SDXL は `--preset base`) |
...
> 差し替えられる構造ができており、NoobAI-XL 1.1 / Animagine XL 4.0 / Illustrious XL v0.1 の
> **3 preset 対応 (2-6d) で実際に載せ替え済み** (既定 illustrious-xl)。ComfyUI 的な機能網羅は追わず、
