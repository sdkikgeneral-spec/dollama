# -*- coding: utf-8 -*-
"""施策B seed sweep 集計・判定 (dollma_c_seedsweep_analyze.py と同形式)。
...
RES = os.path.join(ROOT, "data", "bitnet", "_seedsweep_b", "_results")
...
def main():
    ...
    print("=" * 92)
    print("施策B seed sweep: seed x {#1(base),B-pilot(b)} x {diverse_a,diverse_b} macro 表")
    print("=" * 92)
    ...
    print("\n" + "=" * 92)
    print("per-seed paired delta = B-pilot - #1 (同 seed・per-sample paired)")
    print("=" * 92)
    ...
    print("\n" + "=" * 92)
    print("結論サマリ: (a)+(b)+(c) を全 set/metric で満たせば B-pilot diverse 優位は seed 頑健。")
    print("=" * 92)
