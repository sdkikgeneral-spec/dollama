...
| 自作 VAE decoder 全段 | SSIM **0.999988** (旧掲載 0.999992 からの変化点は `b3fe139` 単独。★**帰属を取り違えた是正が 2 回続いた箇所** — 経緯・出典・禁止事項は measurements-log 「G-8k S5b/S5c 残債」①) / ~~decode 7.96s~~ ★**2-6 最適化に未追随の陳腐化値・要再測** (同 残債④。**見積り・合否の分母に使わないこと**) | test_vae_decode |
